<%@ Page Title="網路書店-訂單查詢" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="mem_orderSel.aspx.cs" Inherits="Member_mem_orderSel" %>
...
<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
    <ul class="list-group">
        ...
        <li class="list-group-item"><a href="#" class="active">訂單紀錄查詢</a></li>
...
<div id="right">
<div class="title1">
   <span class="glyphicon glyphicon-file"></span> 訂單查詢 - 你目前共有 <asp:Label ID="Label10" runat="server"></asp:Label>
    筆訂單。
    </div>
   ...
   <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
        ...
        DataKeyNames="orderID" CssClass="gridview2" 
